  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto max-w-5xl space-y-8 bg-slate-50 border py-12 px-6 md:px-12 dark:bg-transparent rounded-2xl shadow-sm">
        ...
        {/* H2: How JobFit Works */}
        <section id="steps" className="container mx-auto py-12 lg:py-24 space-y-12">
          <div className="text-center space-y-4">
            <h2 className="font-heading text-3xl md:text-4xl font-bold">
        ...
        <section className="container mx-auto space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24 rounded-lg">
        ...
        <section className="container mx-auto space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24 rounded-lg">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            ...
            <div className="w-full max-w-3xl text-left space-y-4 mt-8">
              ...
              <details className="group border rounded-lg bg-background p-4 [&_summary::-webkit-details-marker]:hidden">
                <summary className="flex cursor-pointer items-center justify-between gap-1.5 font-medium text-lg">
                  <span className="font-semibold">Is JobFit.ai free?</span>
                  <span className="shrink-0 rounded-full bg-white p-1.5 text-gray-900 sm:p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="size-5 shrink-0 transition duration-300 group-open:-rotate-180" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                    </svg>
